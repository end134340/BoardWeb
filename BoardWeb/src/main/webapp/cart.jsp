  ...
  <form name="orderform" id="orderform" method="post" class="orderform" action="/Page">
    ...
    <div class="basketdiv" id="basket">
      ...
      <div class="row data" data-id="0" style="display: block;">
        <div class="subdiv">
          <div class="check"><input type="checkbox" name="buy" value="260">&nbsp;</div>
    ...
    <div class="right-align basketrowcmd">
      <a href="javascript:void(0)" class="abutton">선택상품삭제</a>
      <a href="javascript:void(0)" class="abutton">장바구니비우기</a>
    </div>
